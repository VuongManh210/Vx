<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="Vx.Cart" %>
...
<head runat="server">
    ...
    <style>
        ...
        /* Navbar (giữ nguyên từ Home.aspx) */
        .navbar {
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="quantity-container">
                                <asp:Button ID="btnGiam" runat="server" Text="-" CommandName="Decrease" CommandArgument='<%# Eval("ProductId") %>' />
                                <asp:TextBox ID="txtSoLuong" runat="server" Text='<%# Eval("Quantity") %>' ReadOnly="true"></asp:TextBox>
                                <asp:Button ID="btnTang" runat="server" Text="+" CommandName="Increase" CommandArgument='<%# Eval("ProductId") %>' />
                            </div>
                        </td>
                        <td><%# Eval("Total", "{0:N0} VND") %></td>
                        <td>
                            <asp:Button ID="btnXoa" runat="server" Text="Xóa" CssClass="delete-btn" CommandName="Delete" CommandArgument='<%# Eval("ProductId") %>' />
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
            ...
            <div class="action-buttons">
                <a href="Home.aspx">Tiếp tục mua sắm</a>
                <asp:Button ID="btnThanhToan" runat="server" Text="Thanh toán" CssClass="checkout-btn" OnClick="btnThanhToan_Click" />
            </div>
        </div>
