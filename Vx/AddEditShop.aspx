    ...
    <form id="form1" runat="server">
        ...
        <div class="main-content">
            ...
            <div class="form-container">
                <div class="mb-3">
                    <label for="txtShopName" class="form-label">Tên Cửa Hàng</label>
                    <asp:TextBox ID="txtShopName" runat="server" CssClass="form-control" placeholder="Nhập tên cửa hàng" />
                </div>
